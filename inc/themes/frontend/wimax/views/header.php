          ...
          <div class="classy-menu">
            ...
            <div class="classynav">
              <ul id="corenav">
                ...
                <?php }?>
                <?php if(_s("language")){?>
                <li class="language-box cn-dropdown-item"><a class="hover-underline-animation" href="#"><i class="<?php _e( get_data( json_decode(_s("language")) , 'icon') )?>"></i><?php echo _s("language")?></a>
                  <ul class="dropdown">
